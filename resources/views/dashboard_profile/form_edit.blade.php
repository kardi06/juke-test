            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('dashboard-profile.update',$profil->id) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="first_name" id="validationCustom01"
                                   value="{{$profil->first_name}}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                value="{{$profil->last_name}}" required>
                                <div class="valid-feedback">
                                    <span class="right badge badge-success">Looks good!</span>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" name="username" class="form-control" id="validationCustomUsername"
                                        aria-describedby="inputGroupPrepend" value="{{$profil->username}}" required>
                                    <div class="valid-feedback">
                                        <span class="right badge badge-success">Looks good!</span>
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="city" class="form-control" id="validationCustom03" value="{{$profil->city}}" required>
                                <div class="valid-feedback">
                                    <span class="right badge badge-success">Looks good!</span>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="state" class="form-control" id="validationCustom04" value="{{$profil->state}}" required>
                                <div class="valid-feedback">
                                    <span class="right badge badge-success">Looks good!</span>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="zip_code" class="form-control" id="validationCustom05" value="{{$profil->zip_code}}" required>
                                <div class="valid-feedback">
                                    <span class="right badge badge-success">Looks good!</span>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="address" id="validationCustom06" cols="30" rows="5" required>{{$profil->address}}</textarea>
                                <div class="valid-feedback">
                                    <span class="right badge badge-success">Looks good!</span>
                                </div>
                                <div class="invalid-feedback">
